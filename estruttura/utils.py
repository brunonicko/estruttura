from tippo import NamedTuple, Tuple, Union

__all__ = ["resolve_index", "resolve_continuous_slice", "PreMoveData", "pre_move"]
...
def pre_move(length, item, target_index):
    # type: (int, Union[slice, int], int) -> Union[PreMoveData, None]
    """
    ...
    return PreMoveData(target_index, index, stop, post_index, post_stop)
